    ...
    <table class="w-full text-sm text-left rtl:text-right text-body">
        <thead class="text-sm text-body bg-neutral-secondary-soft border-b rounded-base border-default">
            <tr>
                ...
                {{-- UPDATE 1: Menambahkan Kolom Header Image --}}
                <th scope="col" class="px-6 py-3 font-medium">
                    Image
                </th>
                <th scope="col" class="px-6 py-3 font-medium">
        ...
        <tbody>
            ...
            <tr class="bg-neutral-primary border-b border-default">
                ...
                {{-- UPDATE 2: Menambahkan Kolom Data Image --}}
                <td class="px-6 py-4">
                    @if($post->image)
                        <img src="{{ asset('storage/' . $post->image) }}" alt="{{ $post->title }}" class="w-16 h-16 rounded-base object-cover">
                    @else
                        {{-- Catatan: Saya sesuaikan ukurannya menjadi w-16 h-16 agar seragam dengan gambar asli di dalam tabel --}}
                        <img class="w-16 h-16 rounded-base object-cover border border-default bg-gray-100" src="{{ asset('images/preview.jpg') }}" alt="Image preview">
                    @endif
                </td>
