        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="/posts"
                            class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Posts</a>
                    </li>
                    <li>
                        <a href="/dashboard"
                            class="{{ Request::is('dashboard') ? 'text-blue-700' : 'text-gray-900' }} block py-2 px-3 rounded hover:bg-gray-100 md:p-0">My
                            Posts</a>
                    </li>

                    <li>
                        <a href="/dashboard/categories"
                            class="{{ Request::is('dashboard/categories*') ? 'text-blue-700' : 'text-gray-900' }} block py-2 px-3 rounded hover:bg-gray-100 md:p-0">Post
                            Categories</a>
                    </li>
                </ul>
            </div>
